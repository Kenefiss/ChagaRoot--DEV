...
<head>
  ...
  <title>ChangaRoot :: Notification</title>
            ...
            <div class="cb-inner">
              <div class="row">
                <div class="col-xl-6 offset-xl-3 col-lg-10 offset-lg-1">
                  <h1 class="h4 title title-margin">Notification</h1>
                  <div class="cb-notification">
                    ...
                    <div class="cb-notification-item">
                      ...
                      <div class="cb-notification-content">
                        <div class="text">
                          <picture>
                            <source srcset="img/notification-img.webp" type="image/webp">
                            <source srcset="img/notification-img.jpg" type="image/jpg">
                            <img src="img/notification-img.jpg" alt="" loading="lazy">
                          </picture>
                          <p>
                            Your Cleanse Program is ending soon, get 40% off <a href="program-detail.php">The Thrive Program</a> on your first subscription
                          </p>
