...
<head>
  ...
  <title>ChangaRoot :: Subscriptions</title>
                  ...
                  <div class="cb-subs">
                    <div class="row">
                      <div class="col-lg-4 col-sm-6">
                        <div class="sub-item">
                          <a class="sub-img" href="sub-detail.php">
                            <img src="img/program-img-2.svg" alt="" loading="lazy">
                          </a>
                          <a class="sub-title" href="sub-detail.php">
                            <div class="h5 title">
                              The Alchemist Cleanse
                            </div>
                            <i></i>
                          </a>
                          <div class="sub-status in-progress">In process</div>
                        </div>
                      </div>
                      <div class="col-lg-4 col-sm-6">
                        <div class="sub-item">
                          ...
                          <div class="sub-status finished">Finished</div>
                        </div>
                      </div>
                      <div class="col-lg-4 col-sm-6">
                        <div class="sub-item">
