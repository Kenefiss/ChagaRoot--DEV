...
<head>
  ...
  <title>ChangaRoot :: History</title>
      ...
      <div class="section cabinet-section">
        ...
        <div class="container">
          <div class="cb-wrap">
            ...
            <div class="cb-inner">
              <div class="row">
                <div class="col-xxl-8 col-xl-9 offset-xl-3">
                  <h1 class="h4 title title-margin">Order history</h1>
                  <div class="ord-wrap">
                    <div class="ord-wrap-head">
                      <div>Order</div>
                      <div>Address</div>
                      <div>Amount</div>
                      <div>Status</div>
                    ...
                    <div class="ord-item">
                      <div class="ord-item-top">
                        <div class="ord-info">
                          <div class="ord-num">567487646</div>
                          <div class="ord-date">21.02.2022 15:56</div>
                        </div>
                        ...
                        <div class="ord-status in-progress">
                          In process
                        </div>
                        <div class="ord-repeat">
                          <a class="repeat-link" href="checkout.php">
                            <i></i><b>Repeat order</b>
                          </a>
                        </div>
                      </div>
                      <div class="ord-item-toggle">
                        <div class="ord-prog-wrap">
                          <div class="ord-prog">
                            <div class="ord-prog-item">
                              <div class="ord-prog-img">
                                <img src="img/ord-prog-img-1.jpg" alt="" loading="lazy">
                              </div>
                              <div class="ord-prog-info">
                                <div class="title">The Warrior Cleanse</div>
                              </div>
                            </div>
                            <div class="ord-prog-price">1,132.20</div>
                            <div class="ord-prog-qv">x<b>1</b></div>
                            <div class="ord-prog-days">Day 13 / 21</div>
                          </div>
                          <div class="ord-prog-detail">
                            <div class="ord-time">
                              Delivery for today
                            </div>
                            <div class="ord-products">
                              <p>Chaga Mac Burger</p>
                              <p>Chagaroot Street Taco (X3)</p>
                              <p>Pan-Fried Edamame</p>
                            </div>
                            <div class="ord-status in-progress">
                              In process
                            </div>
                        ...
                        <div class="ord-prog-wrap">
                          <div class="ord-prog">
                            <div class="ord-prog-item">
                              <div class="ord-prog-img">
                                <img src="img/ord-prog-img-2.jpg" alt="" loading="lazy">
                              </div>
                              <div class="ord-prog-info">
                                <div class="title">
                            ...
                            <div class="ord-prog-price">1,132.20</div>
                            <div class="ord-prog-qv">x<b>1</b></div>
                            <div class="ord-prog-days">Day 13 / 15</div>
                          </div>
                          <div class="ord-prog-detail">
                            <div class="ord-time">
                              Delivery for today
                    ...
                    <div class="ord-item">
                      <div class="ord-item-top">
                        <div class="ord-info">
                          <div class="ord-num">567487645</div>
                          <div class="ord-date">20.02.2022 14:20</div>
                        </div>
                        <div class="ord-address">
                      ...
                      <div class="ord-item-toggle">
                        <div class="ord-prog-wrap">
                          <div class="ord-prog">
                            <div class="ord-prog-item">
                              <div class="ord-prog-img">
                                <img src="img/ord-prog-img-3.jpg" alt="" loading="lazy">
                              </div>
                              <div class="ord-prog-info">
                                <div class="title">Chaga Mac Burger</div>
                                <div class="text">
                                  Soy-free, gluten-free, mushroom myceliated protein (vegan) burger patty
                                </div>
                              </div>
                            </div>
                            <div class="ord-prog-price">1,132.20</div>
                            <div class="ord-prog-qv">x<b>1</b></div>
                            <div class="ord-prog-days"></div>
                          </div>
                        </div>
                        <div class="ord-prog-wrap">
                          <div class="ord-prog">
                            <div class="ord-prog-item">
                              <div class="ord-prog-img">
                                <img src="img/ord-prog-img-4.jpg" alt="" loading="lazy">
                              </div>
                              <div class="ord-prog-info">
                                <div class="title">
                                  Chagaroot Street Taco (X3)
                                </div>
                              </div>
                            </div>
                            <div class="ord-prog-price">18.00</div>
                            <div class="ord-prog-qv">x<b>1</b></div>
                            <div class="ord-prog-days"></div>
                          </div>
                        </div>
                    ...
                    <div class="ord-item">
                      <div class="ord-item-top">
                        <div class="ord-info">
                          <div class="ord-num">567487644</div>
                          <div class="ord-date">20.01.2022 12:20</div>
                        </div>
                        <div class="ord-address">
                          3318 E Flamingo Rd suite d, Las Vegas, NV 89121
                        </div>
                      ...
                      <div class="ord-item-toggle">
                        <div class="ord-prog-wrap">
                          <div class="ord-prog">
                            ...
                            <div class="ord-prog-price">345</div>
                            <div class="ord-prog-qv">x<b>1</b></div>
                            <div class="ord-prog-days"></div>
                          </div>
                        </div>
                    ...
                    <div class="ord-item">
                      <div class="ord-item-top">
                        <div class="ord-info">
                          <div class="ord-num">567487643</div>
                          <div class="ord-date">10.01.2022 10:50</div>
                        </div>
                        <div class="ord-address">
                          1600 Amphitheatre Parkway Mountain View, CA 94043
                        </div>
                      ...
                      <div class="ord-item-toggle">
                        <div class="ord-prog-wrap">
                          <div class="ord-prog">
                            ...
                            <div class="ord-prog-price">240</div>
                            <div class="ord-prog-qv">x<b>20</b></div>
                            <div class="ord-prog-days"></div>
                          </div>
                        </div>
                      </div>
