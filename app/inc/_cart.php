...
<div class="cart">
  <div class="container">
    <div class="cart-inner">
      <div class="cart-top">
        <div class="title h5">Cart</div>
        <div class="btn-close cart-close"></div>
      </div>
      <div class="cart_items">
        <div class="cart_prd js-product" data-price="154">
          <a class="prod_horiz-img" href="product-detail.php">
            <img class="img imgLoaded" src="img/salad1.jpg" data-i-src="img/salad1.jpg">
          </a>
          <div class="prod_horiz-desc">
            <a class="title h5" href="product-detail.php">Салат з лососем та моцарелою</a>

            <div class="product_additions">460г, великий</div>

            <div class="custom_dropdown">
              <button class="custom_dropdown-title">Ваші додатки</button>
              <div class="custom_dropdown-toggle text-sm">
                1 Х Подвійна курка, 2 Х Соус Цезар
              </div>
            </div>
        ...
        <div class="c-empty-message">
          ...
          <a class="btn btn-primary" href="#">Перейти до каталогу</a>
        </div>
      </div>
      <div class="cart_bottom">
        <div class="c_price-wrap">
          <div>Subtotal:</div>
          <div class="card-total-price" id="card-total-price">$ <b>3,600.00</b></div>
        </div>
        <a class="btn btn-primary" href="checkout.php" href="checkout.php">
          <i>
...
<script defer src="js/app-checkout.js"></script>